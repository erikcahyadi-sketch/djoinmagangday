...
function anggotaSubkategori() {
    ...
    test('Dashboard pinajaman testing', async ({ page }) => {
        ...
        await page.locator('a:has-text("Anggota")').isVisible;
        await page.locator('a:has-text("Anggota")').first().click();
        await page.locator('a:has-text("Penggabungan Data")').isVisible;
        await page.locator('a:has-text("Penggabungan Data")').click();
